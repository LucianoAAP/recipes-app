...
import soupMeals from './mocks/data/soupMeals';
import mealsByIngredient from './mocks/data/mealsByIngredient';
import mealsCategories from './mocks/data/mealCategories';
import mealsByFirstLetter from './mocks/mealsByFirstLetter';
import drinks from './mocks/data/drinks';
import drinksByIngredient from './mocks/data/drinksByIngredient';
import ginDrinks from './mocks/data/ginDrinks';
import drinkCategories from './mocks/data/drinkCategories';
